---
title: "L'ERP, la décision qu'on repousse toujours"
description: "Pourquoi le changement d'ERP est la décision la plus repoussée des PME, et comment on a fini par débloquer la nôtre. - Choix digitaux stratégiques Épisode 6"
date: "2026-04-28"
image: "/blog/ep6-ERP.png"
...
series:
  ...
  episode: 6
seo:
  meta_title: "L'ERP, la décision qu'on repousse toujours"
  meta_description: "Pourquoi le changement d'ERP est la décision la plus repoussée des PME, et comment on a fini par débloquer la nôtre."
  url_slug: "choix-logiciel-6-ERP"
  mots_cles_secondaires: ["ERP", "choix logiciel", "PME", "entreprise", "système d'information", "Digital", "Odoo"]
---
...
Le coût visible. Un changement d'ERP, c'est rarement moins de quelques dizaines de milliers d'euros. Pour une TPE/PME, c'est un poste qui fait peur, parce qu'il est concentré dans le temps.
Le vendor lock-in (un terme que je vais expliquer juste après). Plus vous restez longtemps sur un ERP, plus partir devient compliqué.
La peur de la migration. Récupérer cinq ans de données, paramétrer le nouveau système, former l'équipe, basculer sans casser l'opérationnel. Ça fait beaucoup à porter pour une petite structure.
L'absence de "moment idéal". Il n'y en a jamais. Si l'activité tourne fort, on n'a pas la bande passante. Si elle ralentit, on n'a plus le budget.
Le SaaS pansement qui adoucit la douleur. Le plus pernicieux. Le pansement soulage juste assez pour que la douleur ne soit plus insupportable. L'urgence redescend. La décision attend.

Ces cinq raisons ne sont pas indépendantes. Elles se renforcent. Et plus on attend, plus elles se renforcent encore.
...
Vous reportez depuis trop longtemps une décision sur votre ERP ? Un échange permet souvent de clarifier si vous avez besoin de moderniser, de remplacer, ou simplement de remettre les bonnes questions sur la table. [Contactez-moi](/my/contact) pour en discuter.