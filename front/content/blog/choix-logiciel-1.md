...
### Le contexte : un choix cohérent… à l’époque
...
### Ce que j’ai observé en arrivant
...
- Manipuler les données sous Excel
- croiser manuellement les informations
- reconstruire un tableau de pilotage final
...
### Le vrai problème (et ce n’était pas Excel)

À ce stade, beaucoup auraient conclu : *"il nous faut un nouveau logiciel"*.

En réalité, le problème était plus profond :

- l’ERP ne permettait plus de répondre aux besoins actuels
- aucune vision long terme sur l’évolution de l’entreprise n’avait été intégrée au départ
- les processus avaient évolué, pas le système d’information

Excel n’était qu’un **pansement**, pas la cause.

---

### Ce que j’ai fait (et pourquoi je ne me suis pas arrêté là)
...
- automatiser une partie des traitements
- réduire drastiquement le temps passé sur les exports et croisements de données
- redonner de la visibilité rapidement aux équipes opérationnelles
...
- **court terme** : soulager l’opérationnel
- **moyen / long terme** : repenser le système d’information dans son ensemble
...
- les objectifs business à moyen et long terme
